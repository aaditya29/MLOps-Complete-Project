...
# Apply Bag of Words feature engineering on training and testing dat
...
def apply_bow(train_data: pd.DataFrame, test_data: pd.DataFrame, max_features: int) -> tuple:
    try:
        ...
        X_train = train_data['review'].values  # Extract reviews and sentiments
        y_train = train_data['sentiment'].values
        X_test = test_data['review'].values
        y_test = test_data['sentiment'].values

        X_train_bow = vectorizer.fit_transform(
            X_train)  # Fit and transform training data
